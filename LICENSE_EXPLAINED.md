...
file. If there is ever a difference between this document and the
official license, the `LICENSE` file governs.
...
# What the License Means for Most Users
...
The AGPL does **not** require you to publish:

-   your PDFs,
-   your exported card images,
-   your game content,
-   your adventures,
...
licensing terms of any PDFs or artwork you choose to use.
...
We chose this approach because we believe improvements to community
software should remain part of the community.
...
-   how engineering decisions are made, and
-   why the project is licensed the way it is.

Open-source licensing is one part of building that trust.
