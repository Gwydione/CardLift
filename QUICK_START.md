...
5. Follow the on-screen guidance:
   ...
   - Review the detected cards.
   - Export the images.
6. Open the exported folder and review your exported cards.

After completing the Demo Deck, you are ready to import one of your own print-and-play PDFs.
